...
public class RuntimeExceptionMapper implements ExceptionMapper<RuntimeException> {
    ...
    public Response toResponse(RuntimeException e) {
        ...
        RestError re = new RestError(500, "", "unexpected, try again please", "check server log, "+e.getCause());
        return restErrorToResponse(re);
    }
    private Response restErrorToResponse(RestError re)
    {
